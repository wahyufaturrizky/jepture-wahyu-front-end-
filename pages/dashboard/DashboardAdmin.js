                      ...
                      <ul className="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                        <li className="media">
                          ...
                          <div className="media-body ml-3">
                            ...
                            <div className="text-small text-muted">3,282 <i className="fas fa-caret-down text-danger" />
                            </div>
                          </div>
                        </li>
                        <li className="media">
                          ...
                          <div className="media-body ml-3">
                            ...
                            <div className="text-small text-muted">2,976 <i className="fas fa-caret-down text-danger" />
                            </div>
                          </div>
                        </li>
                        <li className="media">
                          ...
                          <div className="media-body ml-3">
                            ...
                            <div className="text-small text-muted">1,576 <i className="fas fa-caret-up text-success" />
                            </div>
                          </div>
                        </li>
                      </ul>
                    ...
                    <div className="col-sm-6 mt-sm-0 mt-4">
                      ...
                      <ul className="list-unstyled list-unstyled-border list-unstyled-noborder mb-0">
                        <li className="media">
                          ...
                          <div className="media-body ml-3">
                            <div className="media-title">Indonesia</div>
                            <div className="text-small text-muted">3,486 <i className="fas fa-caret-up text-success" />
                            </div>
                          </div>
                        </li>
                        <li className="media">
                          ...
                          <div className="media-body ml-3">
                            ...
                            <div className="text-small text-muted">3,182 <i className="fas fa-caret-up text-success" />
                            </div>
                          </div>
                        </li>
                        <li className="media">
                          ...
                          <div className="media-body ml-3">
                            ...
                            <div className="text-small text-muted">2,317 <i className="fas fa-caret-down text-danger" />
                            </div>
                          </div>
                        </li>
                      </ul>
