            ...
            <section className="section">
              <div className="section-header">
                <div className="section-header-back">
                  <Link as="../ListPost" href="../"><a className="btn btn-icon"><i className="fas fa-arrow-left" /></a>
                  </Link>
                </div>
                <h1>Detail Post</h1>
              ...
              <div className="section-body">
                <h2 className="section-title">Hi, {props.user.author}!</h2>
                  ...
                  <div className="col-12 col-md-12 col-lg-5">
                    <div className="card profile-widget">
                      ...
                      <div className="profile-widget-description">
                        <div className="profile-widget-name">{props.user.author} <div
                            className="text-muted d-inline font-weight-normal">
                            <div className="slash" /> Web Developer</div>
                        </div>
                        {props.user.author} is a superhero name in <b>Indonesia</b>, especially in my family. He is
                        not a fictional character but an original hero in my family, a hero for his children and for
                        his wife. So, I use the name as a user in this template.
                      </div>
                      <div className="card-footer text-center">
                        <div className="font-weight-bold mb-2">Follow {props.user.author} On</div>
                        ...
                        <div className="card-body">
                          ...
                          <div className="row">
                            ...
                            <div className="form-group col-md-6 col-12">
                              ...
                              <p>{props.user.update_at}</p>
                            </div>
                          </div>
                          <div className="row">
                            <div className="form-group col-12">
                              <label>Content Description Body</label>
                              <p>{props.user.body_post}</p>
                            </div>
                          </div>
                        </div>
                        <div className="card-footer text-right">
                          <Link as="../ListPost" href="../"><a className="btn btn-primary mr-2">Back</a></Link>
                        </div>
                      </form>
                    </div>
                  </div>
...
ViewPost.getInitialProps = async ({ query: { id } }, res) => {
