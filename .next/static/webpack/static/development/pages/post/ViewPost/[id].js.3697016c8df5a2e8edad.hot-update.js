...
var ViewPost = function ViewPost(props) {
  return __jsx(_components_LayoutDashboard__WEBPACK_IMPORTED_MODULE_2__["default"], {
    ...
    alt: "image",
    src: "../../../static/assets/img/avatar/avatar-.png",
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          id = _ref.query.id;
          _context.next = 3;
          return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.awrap(isomorphic_unfetch__WEBPACK_IMPORTED_MODULE_4___default()("http://localhost:3004/jsonusers/".concat(id)));
...
//# sourceMappingURL=[id].js.3697016c8df5a2e8edad.hot-update.js.map