      ...
      <div className="main-sidebar sidebar-style-2">
        <aside id="sidebar-wrapper">
          ...
          <ul className="sidebar-menu">
            ...
            <li><a className="nav-link" href="blank.html"><i className="far fa-square" /> <span>Blank Page</span></a>
            </li>
            <li className="dropdown">
            ...
            <li className="dropdown">
              <a href="#" className="nav-link has-dropdown"><i className="fas fa-th-large" />
            ...
            <li className="dropdown">
              <a href="#" className="nav-link has-dropdown"><i className="fas fa-map-marker-alt" /> <span>Google
                  Maps</span></a>
              <ul className="dropdown-menu">
            ...
            <li className="dropdown">
              <a href="#" className="nav-link has-dropdown"><i className="fas fa-ellipsis-h" />
            ...
            <li><a className="nav-link" href="credits.html"><i className="fas fa-pencil-ruler" />
                <span>Credits</span></a>
            </li>
          </ul>
